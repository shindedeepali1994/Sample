package com.firstjhipster.sample.config;
...
@Configuration
@EnableMongoRepositories("com.firstjhipster.sample.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.firstjhipster.sample.config.dbmigrations");
